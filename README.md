DigiByte Seeder ( With built-in webserver & Config file )
===============

![web](https://user-images.githubusercontent.com/125610144/220363447-495cc9a1-82d1-4bce-a34c-ff51dee0d75f.png)
...
$ ```git clone https://github.com/Jongjan88/digibyte-seeder-jj```

Compile the software:

$ ```cd digibyte-seeder-jj```
...
-s <Webport>    tcp port to listen on (default 12080)
...
If you are still having a problem, try opening ports 53 on your firewall:

$ ```sudo ufw allow 53```

### Putty webserver tunnel Port: 12080

![putty](https://user-images.githubusercontent.com/125610144/220364067-02af8cc8-1402-4b93-ace7-a179ab7009a5.png)
